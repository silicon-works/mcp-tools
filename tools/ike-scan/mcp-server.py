...
if __name__ == "__main__":
    RunCliServer.serve(
        name="ike-scan",
        description="IKE/IPsec VPN enumeration and PSK-cracking toolkit wrapping ike-scan 1.9 (`ike-scan` for endpoint discovery, transform enumeration, vendor-ID fingerprinting via backoff, Aggressive-Mode PSK hash capture; `psk-crack` for offline cracking...",
    )
