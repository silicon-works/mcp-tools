...
if __name__ == "__main__":
    RunCliServer.serve(
        name="nc",
        description="Stateless one-shot port operations: nc, ncat, socat, and netcat-traditional for TCP / UDP probe, banner grab, bind-shell connect, and small file transfer.",
    )
