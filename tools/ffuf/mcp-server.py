...
if __name__ == "__main__":
    RunCliServer.serve(
        name="ffuf",
        description="Fast Go-based web fuzzer for directory/file discovery, GET/POST parameter fuzzing, virtual-host enumeration, and arbitrary header/body fuzzing.",
    )
